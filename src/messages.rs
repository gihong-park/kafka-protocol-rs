...
pub use get_replica_log_info_request::GetReplicaLogInfoRequest;
...
pub use get_replica_log_info_response::GetReplicaLogInfoResponse;
...
#[cfg(all(feature = "client", feature = "broker"))]
impl Request for GetReplicaLogInfoRequest {
    const KEY: i16 = 93;
...
pub enum ApiKey {
    ...
    /// API key for request GetReplicaLogInfoRequest
...
impl ApiKey {
    ...
    pub fn request_header_version(&self, version: i16) -> i16 {
        match self {
            ...
            ApiKey::GetReplicaLogInfo => GetReplicaLogInfoRequest::header_version(version),
        }
    }
    ...
    pub fn response_header_version(&self, version: i16) -> i16 {
        match self {
            ...
            ApiKey::GetReplicaLogInfo => GetReplicaLogInfoResponse::header_version(version),
        }
    }
    ...
    pub fn valid_versions(&self) -> VersionRange {
        match self {
            ...
            ApiKey::GetReplicaLogInfo => VersionRange { min: 0, max: 0 },
        }
    }
...
impl TryFrom<i16> for ApiKey {
    ...
    fn try_from(v: i16) -> Result<Self, Self::Error> {
        match v {
            ...
            x if x == ApiKey::GetReplicaLogInfo as i16 => Ok(ApiKey::GetReplicaLogInfo),
            _ => Err(()),
        }
    }
}
...
pub enum RequestKind {
    ...
    GetReplicaLogInfo(GetReplicaLogInfoRequest),
}
...
impl RequestKind {
    ...
    pub fn encode(&self, bytes: &mut bytes::BytesMut, version: i16) -> anyhow::Result<()> {
        match self {
            ...
            RequestKind::GetReplicaLogInfo(x) => encode(x, bytes, version),
        }
    }
    ...
    pub fn decode(
        ...
        match api_key {
            ...
            ApiKey::GetReplicaLogInfo => {
                Ok(RequestKind::GetReplicaLogInfo(decode(bytes, version)?))
            }
        }
    }
}
...
#[cfg(feature = "messages_enums")]
impl From<GetReplicaLogInfoRequest> for RequestKind {
    fn from(value: GetReplicaLogInfoRequest) -> RequestKind {
        RequestKind::GetReplicaLogInfo(value)
    }
}
...
pub enum ResponseKind {
    ...
    GetReplicaLogInfo(GetReplicaLogInfoResponse),
}
...
impl ResponseKind {
    ...
    pub fn encode(&self, bytes: &mut bytes::BytesMut, version: i16) -> anyhow::Result<()> {
        match self {
            ...
            ResponseKind::GetReplicaLogInfo(x) => encode(x, bytes, version),
        }
    }
    /// Decode the message from the provided buffer and version
    #[cfg(feature = "client")]
    pub fn decode(
        ...
        match api_key {
            ...
            ApiKey::GetReplicaLogInfo => {
                Ok(ResponseKind::GetReplicaLogInfo(decode(bytes, version)?))
            }
        }
    }
    /// Get the version of request header that needs to be prepended to this message
    pub fn header_version(&self, version: i16) -> i16 {
        match self {
            ...
            ResponseKind::GetReplicaLogInfo(_) => {
                GetReplicaLogInfoResponse::header_version(version)
            }
        }
    }
}
...
#[cfg(feature = "messages_enums")]
impl From<GetReplicaLogInfoResponse> for ResponseKind {
    fn from(value: GetReplicaLogInfoResponse) -> ResponseKind {
        ResponseKind::GetReplicaLogInfo(value)
    }
}
